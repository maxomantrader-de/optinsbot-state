...
## 🎯 Nächste Priorität
- **Domain-Migration steadyalpha.de (TASK 6):** DNS, nginx, Let's Encrypt, HSTS,
  SPF/DKIM/DMARC p=none, 301-Redirect 60 Tage — **Blocker für Delivery (TASK 5)**
- **Morgenroutine-Delivery (TASK 5):** 2-seitiges A4-PDF, Render 07:55 /
  Versand 08:00 Berlin, byte-identisch für E-Mail-Anhang und Portal-Download
- **Daten-Verifier** (4-Schichten-Gate, fail-closed) — bis dahin dürfen
  Distribution-Day-Werte Kunden NICHT als verifiziert gezeigt werden
- **Zurückgestellt (bestätigt):** Scanner/Trade-Management (Close/Roll) + Stripe
...
- UI-Skill-Doku (`.claude/skills/steady-alpha-ui/SKILL.md`) auf die neue
